...
def parse_args(base_parser, args, namespace):
    ...
    parser.add_argument("--grad_probe_interval", default=0, type=int)
    parser.add_argument("--grad_probe_batches", default=8, type=int)
    parser.add_argument("--grad_probe_data_seed", default=424242, type=int)
