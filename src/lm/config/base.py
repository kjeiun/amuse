...
def parse_args(base_parser, args, namespace):
    ...
    # Checkpointing
    parser.add_argument("--results_base_folder", default="./src/lm/exps", type=str)
    ...
    parser.add_argument("--resume_mode", type=str, default="full", choices=["full", "model_only"])
    parser.add_argument("--auto_resume", nargs="?", const=True, default=False, type=str_to_bool)
    ...
    parser.add_argument(
        "--dynamics_logger_cfg", default="./src/lm/logger/rotational_logger.yaml", type=str
    )
    ...
    parser.add_argument("--adam_beta1", default=0.8, type=float)

    # Schedule
    parser.add_argument(
        "--scheduler",
        default="cos",
        choices=["linear", "cos", "wsd", "none", "linear_zero", "cos_inf"],
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "sgd, muon, d-muon, sf-sgd, amuse (Muon momentum \\mu), signum, scion, "
            "scion-light, and muon-pytorch."
        ),
    )
    ...
    parser.add_argument("--weight_decay_at_y", default=0.0, type=float)
    parser.add_argument("--rho", default=1.0, type=float, help="AMUSE window rho parameter")
    parser.add_argument(
        "--amuse_aux_opt",
        default="adamw",
        choices=["adamw", "sgd"],
        help="Optimizer update used by AMUSE non-Muon parameter groups.",
    )
    ...
    )  # alias to enable EMA eval/logging
    parser.add_argument(
        "--ewa_interval",
        default=10,
        type=int,
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="Optional list of EMA decays to evaluate simultaneously for non-schedule-free optimizers.",
    )
    parser.add_argument(
        "--x_ema_decays",
        nargs="+",
        type=float,
        default=None,
        help="Optional list of x-EMA decays to evaluate simultaneously for schedule-free optimizers.",
    )
    parser.add_argument(
        "--ewa_after_warmup",
        action="store_true",
